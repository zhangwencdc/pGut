...
my $query="group_1";
my $out="Recombination_enzyme.fasta";
open(F,$file);
my $name=<F>;
chomp $name;$name =~ s/"//g;
...
system "mafft --auto Recombination_enzyme.fasta >Recombination_enzyme.aln\n";
system "fasttree  -nt -gtr Recombination_enzyme.aln >Recombination_enzyme.nwk \n";